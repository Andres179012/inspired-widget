...
class rt extends w{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{const s=i?.renderBefore??e;let r=s._$litPart$;if(void 0===r){const t=i?.renderBefore??null;s._$litPart$=r=new G(e.insertBefore(R(),t),t,void 0,i??{})}return r._$AI(t),r})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return B}}rt._$litElement$=!0,rt.finalized=!0,globalThis.litElementHydrateSupport?.({LitElement:rt});const ot=globalThis.litElementPolyfillSupport;ot?.({LitElement:rt}),(globalThis.litElementVersions??=[]).push("4.0.5");class nt extends rt{static properties={widgetId:{type:String,reflect:!0},activeTab:{type:String,reflect:!0},displayedReviewsCount:{type:Number}};static styles=o`
  ...
  `;constructor(){super(),this.widgetId="",this.activeTab="",this.apiEndpoint="https://api-inspired-4e322fa633ca.herokuapp.com",this.reviews={gmb:{reviews:[],url:""},yelp:{reviews:[],url:""},homeadvisor:{reviews:[],url:""}},this.displayedReviewsCount=12}updated(t){t.has("widgetId")&&(console.log(`Updated widgetId: ${this.widgetId}`),this.fetchReviews())}async fetchReviews(){if(!this.apiEndpoint||!this.widgetId)throw new Error("Missing apiEndpoint or widgetId");const t=`${this.apiEndpoint}/get-reviews/${this.widgetId}`;console.log(`Fetching reviews from: ${t}`);try{const e=await fetch(t);if(!e.ok)throw new Error(`HTTP error! status: ${e.status}`);const i=await e.json();console.log("Fetched data:",i),this.reviews=i.reviews||{gmb:{reviews:[],url:""},yelp:{reviews:[],url:""},homeadvisor:{reviews:[],url:""}},this.setDefaultTab(),this.requestUpdate()}catch(t){console.error("Error fetching reviews:",t),this.reviews={gmb:{reviews:[],url:""},yelp:{reviews:[],url:""},homeadvisor:{reviews:[],url:""}}}}setDefaultTab(){const t=["gmb","yelp","homeadvisor"];for(let e of t)if(this.reviews[e]&&this.reviews[e].reviews.length>0)return void(this.activeTab=e);this.activeTab=t[0]}handleTabClick(t){this.activeTab=t,this.displayedReviewsCount=12}toggleReadMore(t){const e=t.target.previousElementSibling;e.classList.toggle("expanded"),t.target.textContent=e.classList.contains("expanded")?"Hide":"Read more"}loadMoreReviews(){this.displayedReviewsCount+=12}renderTabs(t){return["gmb","yelp","homeadvisor"].map((e=>{const i=this.calculateAverageStars(t[e].reviews);return t[e]&&t[e].reviews.length>0?D`<div
